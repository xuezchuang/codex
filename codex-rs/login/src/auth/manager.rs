...
pub const OPENAI_API_KEY_ENV_VAR: &str = "CODEFORGE_API_KEY";
pub const CODEX_API_KEY_ENV_VAR: &str = "CODEFORGE_API_KEY";
pub const CODEX_ACCESS_TOKEN_ENV_VAR: &str = "CODEFORGE_ACCESS_TOKEN";
